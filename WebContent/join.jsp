		...
		<div class="col-lg-4">
			...
			<div class="jumbotron" styles="padding-top:20px;">
				<form method="post" action="joinAction.jsp">
					...
					<div class="form-group">
						<input type="text" class="form-control" placeholder="이름" name="userName" maxlength="20">	<!-- 이름 입력받는 창 -->
					</div>
					<div class="form-group" style="text-align: left;">	<!-- 성별 입력 -->
					...
					<div class="form-group">
						<input type="email" class="form-control" placeholder="Email" name="userEmail" maxlength="50">	<!-- 이메일 입력받는 창 -->
					</div>
						<input type="submit" class="btn btn-primary form-control" value="회원가입">		<!-- 회원가입 버튼 -->
				</form>
			</div>
